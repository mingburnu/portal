...
<a class="btn_02" onClick="document.getElementById('state_A').submit();">查詢</a>
...
@if(count($report) > 0 )
    ...
    <div class="func_box">
        <a class="btn_02" href="{{ url('/state_A_output/' . $Year . '/' . $Month) }}">PDF 匯出</a>
        <a class="btn_02" href="{{ url('/state_A_output_csv/' . $Year . '/' . $Month) }}">CSV 匯出</a>
    </div>
