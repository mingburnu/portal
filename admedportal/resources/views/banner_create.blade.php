            ...
            <tr valign="top">
                ...
                <td class="td_2">
                    ...
                    <div class="detail_box">
                        ...
                        <form id="banner_id" method="POST" action="{{route('banner.store')}}"
                              enctype="multipart/form-data">
                            {!! Form::open(['method' => 'POST','route'=>['banner.store']]) !!}
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <th>Banner標題</th>
                                    <td>
                                        @foreach($languages as $language)
                                            @if($language->id==0)
                                                ...
                                                <div>
                                                    {!! Form::text('title',null,['cols'=>'80','rows'=>'10','class'=>'v_01']) !!}
                                                </div>
                                            @else
                                                <h3>{{$language->language}}</h3>

                                                <div>
                                                    {!! Form::text('banner_i18ns['.$language->id.'][title]',null,['cols'=>'80','rows'=>'10','class'=>'v_01']) !!}
                                                </div>
                                            @endif
                                        @endforeach
                                    </td>
                                    ...
                                    <td>
                                        @foreach($languages as $language)
                                            @if($language->id==0)
                                                ...
                                                <div>
                                                    {!! Form::text('info',null,['cols'=>'80','rows'=>'10','class'=>'v_01']) !!}
                                                </div>
                                            @else
                                                <h3>{{$language->language}}</h3>

                                                <div>
                                                    {!! Form::text('banner_i18ns['.$language->id.'][info]',null,['cols'=>'80','rows'=>'10','class'=>'v_01']) !!}
                                                </div>
                                            @endif
                                        @endforeach
                                    </td>
