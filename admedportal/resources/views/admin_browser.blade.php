...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr valign="top">
    ...
    <td class="message_close" valign="middle"><a href="javascript:void(0);" onClick="message_print_errer_hide();">關閉</a></td>
  </tr>
</table>
</div>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
  ...
  @if(count($user))  
    ...
    <tr>
        ...
        <td>
            <a class="btn_03" href="{{ $url = route('admin.broweser.id.delete', ['id' => $user[$i]->id ] ) }}">刪除</a>
            <a class="btn_02" href="{{ $url = route('admin.edit', ['id' => $user[$i]->id ] ) }}">修改</a>
        </td>
    </tr>
    @endfor
