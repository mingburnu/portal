...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    @if( $paper[0]->type == 1 )
        <td><a target="_blank" href="{{ Config::get('app.url') . '/pages/' . $paper[0]->id }}">預覽</a></td>
    @elseif( $paper[0]->type == 2)
        <td><a target="_blank" href="{{ Config::get('app.url') . '/pages/' . $paper[0]->id . '/' . $paper[0]->type }}">預覽</a></td>
    @endif
  </tr>
  <tr>
    <th>連結</th>
