                                    ...
                                    <td>
                                        @foreach($languages as $language)
                                            @if($language->id==0)
                                                ...
                                                <div>
                                                    {!! Form::text('book_name',$book[0]->book_name,['cols'=>'80','rows'=>'10','class'=>'v_01']) !!}
                                                </div>
                                            @else
                                                <?php
                                                $i18n_bkName = null;
                                                foreach ($book_i18n as $i18n_bk) {
                                                ...
                                                <div>
                                                    {!! Form::text($language->id.'_book_name',$i18n_bkName,['cols'=>'80','rows'=>'10','class'=>'v_01']) !!}
                                                </div>
                                            @endif
                                        @endforeach
                                    </td>
