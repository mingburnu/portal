                ...
                <td class="td_2">
                    ...
                    @if(Session::get('success'))
                        ...
                        <div class="detail_box">
                            ...
                            <form id="webconfig" method="POST" enctype="multipart/form-data" action="/sys_edit_2/post">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tbody>
                                    <tr>
                                        <th>網站名稱</th>
                                        <td>
                                            ...
                                            <div>
                                                <input class="v_01" type="text" name="site_name_ch"
                                                       value="{{$webconfig[0]->site_name_ch}}">
                                            </div>
                                            <h3>简体中文</h3>

                                            <div>
                                                <input type="text" name="site_name_cn"
                                                       value="{{$webconfig[0]->site_name_cn}}">
                                            </div>
                                            <h3>English</h3>

                                            <div>
                                                <input type="text" name="site_name_en"
                                                       value="{{$webconfig[0]->site_name_en}}">
                                            </div>
                                            <h3>日本語</h3>

                                            <div>
                                                <input type="text" name="site_name_jp"
                                                       value="{{$webconfig[0]->site_name_jp}}">
                                            </div>
                                            <h3>한국어</h3>

                                            <div>
                                                <input type="text" name="site_name_kr"
                                                       value="{{$webconfig[0]->site_name_kr}}">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn_02" href="javascript:void(0);" onclick="toSubmit(true);">下一步</a>
...
<script>
    function toSubmit(next) {
        if (next) {
            $("form#webconfig").attr("action", "/sys_edit_2/post/next");
        }
        else {
            $("form#webconfig").attr("action", "/sys_edit_2/post");
        }
