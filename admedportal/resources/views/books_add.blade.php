...
<form id="books_add" method="POST" enctype="multipart/form-data" action="/books_add/post">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <th>書封(&#8226;)</th>
    <td>
    <div>
        使用方式：
        <label><input type="radio" name="upload_option" value="1" onClick="chgShowField('upload_option','pic');" checked>上傳圖檔</label>
        <label><input type="radio" name="upload_option" value="2" onClick="chgShowField('upload_option','url');">圖檔網址</label>
    </div>
    
    <div class="upload_option pic">上傳圖檔：<input type="file" name="upload_file"></div>
    <div class="upload_option url" style="display:none;">圖檔網址：<input type="text" name="cover"></div>
  ...
  <tr>
    <th>排序</th>
    <td><input class="v_00" type="text" name="rand_id">
  ...
  <tr>
    ...
    <a class="btn_02" onClick="document.getElementById('books_add').submit();">送出</a>
    </td>
  </tr>
</table>
</form>
